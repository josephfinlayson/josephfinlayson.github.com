...
angular.module('dd.fake-typer', [])
  ...
  .controller('ddFakeTyperController', ['$scope', '$interval', '$q', '$timeout', 'ddFakeTyperConfig', function FakeTyperCtrl($scope, $interval, $q, $timeout, ddFakeTyperConfig) {
    var ctrl = this,
 ...
 * </dd-fake-type-option>
 */
.directive('ddFakeTyperOption', ['$timeout', function($timeout) {
  return {
    require: '^ddFakeTyper',
    restrict: 'E',
    link: function($scope, $element, $attrs, ddFakeTyperController) {
